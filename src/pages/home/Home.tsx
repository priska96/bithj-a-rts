  ...
  return (
    <div className="min-h-screen">
      ...
      <CTASection
        ...
        subheading={t("home.cta.subheading")}
        primaryButtonText={t("home.cta.primaryButton")}
            ...
            <div className="flex items-center justify-center">
              <div className="relative">
                ...
                <img
                  ...
                  alt={t("home.featured.artistAtWorkAlt")}
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <Button to={RoutePaths.ABOUT} variant="solidPrimary">
                  {t("home.about.primaryButton")}
                </Button>
                <Button to={RoutePaths.PORTFOLIO} variant="outlinePrimary">
                  {t("home.about.secondaryButton")}
                </Button>
              </div>
            </div>
          </div>
