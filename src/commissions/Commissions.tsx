        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="lg:order-1">
                <div className="relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-primary/10">
                    <div className="flex items-center justify-center w-16 h-16 rounded-full bg-primary text-white text-2xl font-bold mb-6">
                      1
                    </div>
                    <h3 className="text-3xl font-bold text-main-text mb-4">
                      Personal Consultation
                    </h3>
                    <p className="text-lg text-gray-700 leading-relaxed">
                      Every commissioned piece begins with an open conversation.
                      We'll discuss what moves you— thoughts, motifs, images, or
                      life phases seeking expression. My existing works can
                      serve as a starting point. From this dialogue, the
                      foundation for your personal artwork emerges.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="lg:order-2">
                <div className="relative">
                  <div className="absolute -inset-1 bg-purple-600 rounded-3xl blur-xl opacity-25"></div>
                  <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-purple-100">
                    <div className="flex items-center justify-center w-16 h-16 rounded-full bg-purple-600 text-white text-2xl font-bold mb-6">
                      2
                    </div>
                    <h3 className="text-3xl font-bold text-main-text mb-4">
                      Concept Development
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      From our conversation, I develop an initial conceptual and
                      visual design. Sketches and visual ideas make visible the
                      direction the work can take. We'll discuss these drafts
                      together, refining motifs, atmosphere, and details until
                      everything feels right. Step by step, a clear vision of
                      your personal artwork emerges.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="lg:order-1">
                <div className="relative">
                  <div className="absolute -inset-1 bg-pink-500 rounded-3xl blur-xl opacity-25"></div>
                  <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-pink-100">
                    <div className="flex items-center justify-center w-16 h-16 rounded-full bg-pink-500 text-white text-2xl font-bold mb-6">
                      3
                    </div>
                    <h3 className="text-3xl font-bold text-main-text mb-4">
                      Creation
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      Once our shared vision is established, the artistic
                      process begins. I work along our design while staying true
                      to my artistic signature. You'll receive progress updates
                      throughout the creation process, ensuring the final piece
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="relative">
              <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-primary/10">
                <div className="flex items-center mb-6">
                  <svg
                    className="w-12 h-12 text-primary mr-4"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <h3 className="text-3xl font-bold text-main-text">
                    Investment
                  </h3>
                </div>
            ...
            {/* Timeline */}
            <div className="relative">
              <div className="absolute -inset-1 bg-purple-200 rounded-3xl blur-2xl opacity-30"></div>
              <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-purple-100">
                <div className="flex items-center mb-6">
                  <svg
                ...
                <p className="text-lg text-gray-700 mb-6">
                  ...
                  <span className="font-bold text-purple-600">4-8 weeks</span>,
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-main-text sm:text-5xl mb-4">
              Request a Commission
            </h2>
            <p className="text-xl text-main-text/70">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-primary/20 focus:outline-none focus:ring-2 focus:ring-primary/20"
                  />
                </div>
                <div>
                  <label
